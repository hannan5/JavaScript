...
console.log(Year);
   ...
   var differnce = now.getTime() - dob.getTime();

   console.log(differnce);
   var convert_sec = (differnce/ (1000));
   // console.log(convert_sec);
   var convert_min =(convert_sec/ 60);
   // console.log(convert_min);
   var convert_hour =(convert_min/ 60);
   // console.log(convert_hour);
   var convert_days =(convert_hour/ 24);
   // console.log(convert_days);
var currentYear = now.getFullYear();
var dob_year = dob.getFullYear();

var  age_year = currentYear - dob_year;
console.log(dob_year); 
   ...
   let final_month = differnce / (1000 * 60 * 60 * 24 * 30.43);
